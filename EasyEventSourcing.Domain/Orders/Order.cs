...
namespace EasyEventSourcing.Domain.Orders
{
    public class Order : Aggregate
    {
        ...
        {
            this.ApplyChanges(new OrderCreated { OrderId = orderId, ClientId = clientId, Items = items.ToArray() });
        }
        ...
        public void ProvideShippingAddress(string address)
        {
            ...
            {
                this.ApplyChanges(new ShippingAddressConfirmed { OrderId = this.id, Address = address });
            }
        }
        ...
        public void Pay()
        {
            ...
            {
                this.ApplyChanges(new PaymentReceived { OrderId = this.id });
            }
        }
        ...
        public void CompleteOrder()
        {
            ...
            this.ApplyChanges(new OrderCompleted { OrderId = this.id });
        }
