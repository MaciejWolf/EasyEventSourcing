...
namespace EasyEventSourcing.Tests.Domain.Store
{
    class ShoppingCartTests : Spesification
    {
        ...
        //{
        //    this.GivenNewCart();
        //    this.When(new AddProductToCart(this.cartId, this.productId));
        //    this.Then(new ProductAddedToCart(this.cartId, this.productId));
        //}
        ...
        //    this.GivenNewCart();
        //    this.AndAddedProduct();
        //    this.And<ShoppingCart, ProductAddedToCart>(this.cartId, new ProductAddedToCart(this.cartId, Guid.NewGuid()));
        ...
        //        new OrderCreated(this.cartId, this.clientId, new OrderItem[]
        //                                                         {
        //                                                             // TODO removed while sorting out productPrice
        ...
        //    this.ThrowsWhen<CartAlreadyCheckedOutException, AddProductToCart>(new AddProductToCart(this.cartId, this.productId));
        //}
        ...
        //{
        //    this.And<ShoppingCart, ProductAddedToCart>(this.cartId, new ProductAddedToCart(this.cartId, this.productId));
        //}
